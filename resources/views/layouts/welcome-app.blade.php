                                        ...
                                        <nav>
                                            <ul id="navigation">
                                                <li><a href="#">
                                                    ...
                                                    {{ $byshop->name }}
                                                    @elseif ($byshop == null)
                                                      {{ trans('messages.lnk_shop') }}
                                                    @else
                                                     {{ trans('messages.lnk_shop') }} 
                                                    @endif <i class="ti-angle-down"></i></a>
                                                    <ul class="submenu">
                                                        @forelse($shopsName as $key => $shopName)
                                                        <li><a href="{{url('/byShop/'.$key.'/service')}}">{{ $shopName }}</a></li>
                                                        @empty
                                                            <p>Please Register Shops</p>
                                                        @endforelse
                                                    </ul>
                                                </li>
